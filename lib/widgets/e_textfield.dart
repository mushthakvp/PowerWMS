...
class _TextFieldSelectionGestureDetectorBuilders
    extends TextSelectionGestureDetectorBuilders {
  ...
  const ETextField({
    ...
    this.enableIMEPersonalizedLearning = true,
        ...
        assert(maxLength == null ||
            maxLength == ETextField.noMaxLength ||
            maxLength > 0),
...
class _ETextFieldState extends State<ETextField>
    ...
    implements TextSelectionGestureDetectorBuildersDelegate, AutofillClient {
  ...
  late _TextFieldSelectionGestureDetectorBuilders
  ...
  @override
  final GlobalKey<EEditableTextState> editableTextKey =
      GlobalKey<EEditableTextState>();
  ...
  void initState() {
    super.initState();
    _selectionGestureDetectorBuilder =
        _TextFieldSelectionGestureDetectorBuilders(state: this);
