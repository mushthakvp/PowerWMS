...
import 'package:scanner/widgets/e_editable.dart';
import 'package:scanner/widgets/e_selection.dart';
...
class _TextFieldSelectionGestureDetectorBuilders extends TextSelectionGestureDetectorBuilders {
  _TextFieldSelectionGestureDetectorBuilders({
    required _ETextFieldState state,
  }) : _state = state,
        super(delegate: state);

  final _ETextFieldState _state;
...
class ETextField extends StatefulWidget {
  ...
  const ETextField({
    ...
    this.enableIMEPersonalizedLearning = true,
        ...
        assert(maxLength == null || maxLength == ETextField.noMaxLength || maxLength > 0),
...
class _ETextFieldState extends State<ETextField> with RestorationMixin implements TextSelectionGestureDetectorBuildersDelegate, AutofillClient {
  ...
  late _TextFieldSelectionGestureDetectorBuilders _selectionGestureDetectorBuilder;
  ...
  @override
  final GlobalKey<EEditableTextState> editableTextKey = GlobalKey<EEditableTextState>();
  ...
  void initState() {
    super.initState();
    _selectionGestureDetectorBuilder = _TextFieldSelectionGestureDetectorBuilders(state: this);
  ...
  @override
  void didUpdateWidget(ETextField oldWidget) {
  ...
  EEditableTextState? get _editableText => editableTextKey.currentState;
