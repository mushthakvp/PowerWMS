...
///    text field.
abstract class TextSelectionGestureDetectorBuildersDelegate {
  /// [GlobalKey] to the [EditableText] for which the
  /// [TextSelectionGestureDetectorBuilder] will build a [TextSelectionGestureDetector].
  GlobalKey<EEditableTextState> get editableTextKey;
...
class TextSelectionGestureDetectorBuilders {
  /// Creates a [TextSelectionGestureDetectorBuilder].
  ///
  /// The [delegate] must not be null.
  TextSelectionGestureDetectorBuilders({
  ...
  @protected
  final TextSelectionGestureDetectorBuildersDelegate delegate;
  ...
  @protected
  EEditableTextState get editableText => delegate.editableTextKey.currentState!;
