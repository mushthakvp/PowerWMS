...
///
/// {@template flutter.widgets.EEditableText.lifeCycle}
/// ## Lifecycle
///
...
///
/// {@template flutter.widgets.EEditableText.showCaretOnScreen}
...
class EEditableText extends StatefulWidget {
  ...
  /// {@template flutter.widgets.EEditableText.obscuringCharacter}
  ...
  /// {@template flutter.widgets.EEditableText.obscureText}
  ...
  /// {@template flutter.widgets.EEditableText.readOnly}
  ...
  /// {@template flutter.widgets.EEditableText.showCursor}
  ...
  /// {@template flutter.widgets.EEditableText.autocorrect}
  ...
  /// {@template flutter.widgets.EEditableText.strutStyle}
  ...
  /// {@template flutter.widgets.EEditableText.textAlign}
  ...
  /// {@template flutter.widgets.EEditableText.textDirection}
  ...
  /// {@template flutter.widgets.EEditableText.textCapitalization}
  ...
  /// {@template flutter.widgets.EEditableText.textScaleFactor}
  ...
  /// {@template flutter.widgets.EEditableText.maxLines}
  ...
  /// {@template flutter.widgets.EEditableText.minLines}
  ...
  /// {@template flutter.widgets.EEditableText.expands}
  ...
  /// {@template flutter.widgets.EEditableText.autofocus}
  ...
  /// {@template flutter.widgets.EEditableText.selectionControls}
  ...
  /// {@template flutter.widgets.EEditableText.keyboardType}
  ...
  /// {@template flutter.widgets.EEditableText.onChanged}
  ...
  /// {@template flutter.widgets.EEditableText.onEditingComplete}
  ...
  /// {@template flutter.widgets.EEditableText.onSubmitted}
  ...
  /// {@template flutter.widgets.EEditableText.onAppPrivateCommand}
  ...
  /// {@template flutter.widgets.EEditableText.onSelectionChanged}
  ...
  /// {@template flutter.widgets.EEditableText.inputFormatters}
  ...
  /// {@template flutter.widgets.EEditableText.cursorWidth}
  ...
  /// {@template flutter.widgets.EEditableText.cursorHeight}
  ...
  /// {@template flutter.widgets.EEditableText.cursorRadius}
  ...
  /// {@template flutter.widgets.EEditableText.scrollPadding}
  ...
  /// {@template flutter.widgets.EEditableText.enableInteractiveSelection}
  ...
  /// {@template flutter.widgets.EEditableText.scrollController}
  ...
  /// {@template flutter.widgets.EEditableText.scrollPhysics}
  ...
  /// {@template flutter.widgets.EEditableText.scribbleEnabled}
  ...
  /// {@template flutter.widgets.EEditableText.selectionEnabled}
  ...
  /// {@template flutter.widgets.EEditableText.autofillHints}
  ...
  @override
  EEditableTextState createState() => EEditableTextState();
...
class EEditableTextState extends State<EEditableText> with AutomaticKeepAliveClientMixin<EEditableText>, WidgetsBindingObserver, TickerProviderStateMixin<EEditableText>, TextSelectionDelegate implements TextInputClient, AutofillClient {
  Timer? _cursorTimer;
  ...
  @override
  void didUpdateWidget(EEditableText oldWidget) {
  ...
  void _cursorWaitForStart(Timer timer) {
    ...
    assert(!EEditableText.debugDeterministicCursor);
    _cursorTimer?.cancel();
  ...
  void _startCursorTimer() {
    ...
    if (EEditableText.debugDeterministicCursor)
      return;
    if (widget.cursorOpacityAnimates) {
                  ...
                  child: Semantics(
                    ...
                    child: _ScribbleFocusable(
                      ...
                      child: _Editable(
                        ...
                        showCursor: EEditableText.debugDeterministicCursor
...
class _DeleteTextAction<T extends DirectionalTextEditingIntent> extends ContextAction<T> {
  ...
  final EEditableTextState state;
